 ...
 * SDK composition root passes `createModelClient` here; tests inject a stub
 ...
 *
 * P1-A: this function was previously in `apps/cli/src/model-client-wiring.ts`.
 * It has been moved to the SDK so that CLI, SDK, and ACP composition roots
 * all share the same fallback-chain assembly logic. The CLI re-exports it
 * from the SDK for backward compatibility.
 */
